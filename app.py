...
app.secret_key = '192837465SuperSecretKey'
...
def login():
    if 'username' in session:
        ...
        if request.method == 'POST':
            if request.form['username'] != 'iflask' or request.form['password'] != 'IFLASKadmin':
                error = 'Not correct Credentials. Please try again.'
            else:
                session['username'] = 'iflask'
                return redirect('/')
